    ...
    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        ...
        match action {
            ...
            TeamsPageAction::RemoveUserFromTeam {
                ...
                let variant = Self::remove_team_member_confirmation_variant(
...
impl TeamsPageView {
    ...
    fn remove_team_member_confirmation_variant(
        ...
        member_email: &str,
        legacy_confirmation_enabled: bool,
        ...
        team.members.iter().for_each(|member| {
            ...
            if member.email != *current_user_email {
                ...
                if current_user_is_workspace_admin
                    && workspace.is_native_workspaces_enabled()
                    && member_workspace_role.is_some_and(|role| role != MembershipRole::Owner)
                {
                    actions.push(ItemAction {
                        icon: Icon::X,
