...
pub enum CloudActionConfirmationDialogVariant {
    ...
    RemoveUserFromNativeWorkspaceTeam {
        email: String,
    ...
    fn body_text(&self) -> String {
        match &self.variant {
            ...
            CloudActionConfirmationDialogVariant::RemoveUserFromNativeWorkspaceTeam {
                ...
                "Are you sure you want to remove {email} from this team? {email} will still keep \
                 their {workspace_name} workspace membership and their other team memberships."
            ),
            CloudActionConfirmationDialogVariant::RemoveUserFromWorkspace {
                email,
                workspace_name,
            } => format!(
                "Are you sure you want to remove {email} from the workspace? This will remove \
                 {email} from all teams in {workspace_name} and from the workspace itself."
            ),
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
