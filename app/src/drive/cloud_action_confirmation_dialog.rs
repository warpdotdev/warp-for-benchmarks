...
impl CloudActionConfirmationDialog {
    ...
    fn title_text(&self) -> String {
        match &self.variant {
            ...
            CloudActionConfirmationDialogVariant::RemoveFromNativeTeam { .. } => {
    ...
    fn body_text(&self) -> String {
        match &self.variant {
            ...
            CloudActionConfirmationDialogVariant::RemoveFromWorkspace {
                ...
                "This will remove {member_email} from all teams in {workspace_name} and from the workspace itself."
            ),
            CloudActionConfirmationDialogVariant::RemoveFromNativeTeam {
                member_email,
                workspace_name,
            } => format!(
                "{member_email} will remain in {workspace_name} and any other teams they belong to."
            ),
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
