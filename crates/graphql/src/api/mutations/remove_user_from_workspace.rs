...
/*
mutation RemoveUserFromWorkspace($input: RemoveUserFromWorkspaceInput!, $requestContext: RequestContext!) {
  removeUserFromWorkspace(input: $input, requestContext: $requestContext) {
    ... on RemoveUserFromWorkspaceOutput {
      success
      responseContext {
        serverVersion
      }
